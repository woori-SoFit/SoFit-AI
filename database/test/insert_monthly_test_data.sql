...
-- 시나리오:
--   - 3명의 사용자가 s_input_feature에 존재 (전체 회원)
--   - user_id=1001에 대해 REQUESTED 요청 1건 존재 (월별 배치가 흡수해야 함)
--   - user_id=1003은 요청 없이 피처만 존재 (월별 배치에서 등급 갱신)
-- ============================================================
...
-- user_id=1001: 성장세 매장 (REQUESTED 요청도 있음)
(1, 101, 1001,
 24, 12.50, 8.30, 1.20,
...
(2, 102, 1002,
 ...
 80.00, 0, 15, 1, 0, NOW()),
-- user_id=1003: 온라인 중심 신규 매장 (요청 없음, 월별 배치에서만 처리)
(3, 103, 1003,
 6, 25.00, 0.00, 0.60,
...
-- 2. s_calculation_request: user_id=1001에 대한 REQUESTED 요청 1건
